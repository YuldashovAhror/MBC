	...
	<div class="container">
		...
		<div class="history-timeline">
				...
				<div class="history-item__wrap">
					<div class="history-item__block wow fadeInLeft" data-wow-delay=".3s">
						<div class="history-item__img">
							<img src="img/history/2003.jpg" alt="img">
						</div>
						<div class="history-item__text">
							Положено начало крупной строительной компании “Murad Buildings”
						</div>
					</div>
				</div>
			</div>
			...
			<div class="history-item">
				...
				<div class="history-item__wrap">
					...
					<div class="history-item__block wow fadeInRight" data-wow-delay=".3s">
						...
						<div class="history-item__text">
							Получение премии “Лучший работодатель Узбекистана” в номинации “Выбор студентов” по версии Davinci
						</div>
					</div>
				</div>
			</div>
			<div class="history-item">
				...
				<div class="history-item__wrap">
					...
					<div class="history-item__block wow fadeInRight" data-wow-delay=".3s">
						<div class="history-item__img">
							<img src="img/history/2018-5-1.jpg" alt="img">
						</div>
						<div class="history-item__text">
				...
				<div class="history-item__wrap">
					<div class="history-item__block wow fadeInLeft" data-wow-delay=".3s">
						...
						<div class="history-item__text">
							Получение награды за "Самую инновационную презентацию проекта" на “World Build Tashkent”
						</div>
					</div>
					<div class="history-item__block wow fadeInRight" data-wow-delay=".3s">
						<div class="history-item__img">
				...
				<div class="history-item__wrap">
					...
					<div class="history-item__block wow fadeInRight" data-wow-delay=".3s">
						...
						<div class="history-item__text">
							Получение премии “Самый желаемый работодатель” по версии Davinci
						</div>
					</div>
				</div>
			</div>
			<div class="history-item">
				...
				<div class="history-item__wrap">
					<div class="history-item__block wow fadeInLeft" data-wow-delay=".3s">
						...
						<div class="history-item__text">
							Получение премии “Лучший работодатель 2020” по версии Davinci
						</div>
					</div>
				</div>
				<div class="history-item__wrap">
					...
					<div class="history-item__block wow fadeInRight" data-wow-delay=".3s">
						...
						<div class="history-item__text">
							Получение премии “Бренд года 2019” по версии маркетинговой ассоциации Узбекистана
						</div>
					</div>
				</div>
			</div>
			<div class="history-item">
				...
				<div class="history-item__wrap">
					<div class="history-item__block wow fadeInLeft" data-wow-delay=".3s">
						...
						<div class="history-item__text">
							Принятие участия в ежегодном Ташкентском полумарафоне
						</div>
					</div>
					<div class="history-item__block wow fadeInRight" data-wow-delay=".3s">
						<div class="history-item__img">
						...
						<div class="history-item__text">
							Принятие участия в ежегодном Самаркандском полумарафоне
						</div>
					</div>
				</div>
				<div class="history-item__wrap">
			...
			<div class="history-item">
				...
				<div class="history-item__wrap">
					...
					<div class="history-item__block wow fadeInRight" data-wow-delay=".3s">
						...
						<div class="history-item__text">
							Получение премии “Бренд года 2021” по версии маркетинговой ассоциации Узбекистана
						</div>
					</div>
				</div>
				<div class="history-item__wrap">
				...
				<div class="history-item__wrap">
					...
					<div class="history-item__block wow fadeInRight" data-wow-delay=".3s">
						...
						<div class="history-item__text">
							Получение награды в категории “Digital кампания” на Ташкентском фестивале рекламы
						</div>
					</div>
				</div>
			</div>
		...
		<div class="history-footer">
			<div class="history-footer__copy">
				&copy; 2022 Murad Buildings. Все права защищены.
			</div>
