		...
		<div class="news-single__main">
			<div class="container">
				<div class="news-single__content">
					<a href="/career" class="news-single__back">
						<div>
				...
				<div class="news-single__sidebar">
					...
					@foreach (App\Models\Blog::paginate(3) as $blog)
						<div class="blog-carousel__item">
							<div class="blog-carousel__wrap">
								...
								<div class="blog-carousel__link">
									<a href="{{route('career.show', $blog->id)}}">{{__('asd.Подробнее')}}</a>
								</div>
							</div>
						</div>
					@endforeach
			...
			<div class="container">
				...
				<div class="footer-item">
					...
					<div class="footer-item__text">
						Бизнес-центр "Авалон", 1-этаж, ул. Ойбека 38а, г.Ташкент
					</div>
				</div>
				<div class="footer-item">
					<div class="footer-item__title">
				...
				<div class="footer-copy">
					© 2022 Murad Buildings. Все права защищены.
				</div>
			</div>
