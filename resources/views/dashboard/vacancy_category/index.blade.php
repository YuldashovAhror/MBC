...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.vacancycategory.store')}}" method="POST">
            @csrf
            <div class="row g-4">
                <div class="col-md-4">
...
<div class="col-sm-6" style="padding-top: 2rem; padding-bottom: 1.5rem">
    <h3>Категория вакансии Список</h3>
</div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{$cat->name_en}}</td>
                            <td>
                                <form action="{{route('admin.vacancycategory.edit', $cat->id)}}" method="GET" style="display: inline;">
                                    <button class="btn btn-xs btn-primary" type="submit"><i data-feather="edit"></i></button>
                                </form>
                                
                                    <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{$cat->id}}" data-bs-original-title="" title=""><i data-feather="trash-2"></i></button>
                            </td>
                            <div class="modal fade" id="exampleModalCenter{{$cat->id}}" tabindex="-1" aria-labelledby="exampleModalCenter" style="display: none;" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{route('admin.vacancycategory.destroy', $cat->id)}}" method="post">
                                            @csrf
                                            @method('delete')
