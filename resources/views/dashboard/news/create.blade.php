        ...
        <form action="{{route('admin.news.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-8">
                    ...
                    <input class="form-control" name="photo_main" id="photo_main" type="file" placeholder="..." required="" value="">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label" for="date">Дата</label>
                    <div class="input-group">
                        <input class="form-control" name="date" id="link" type="date" placeholder="..." aria-describedby="inputGroupPrepend2" required="">
                    </div>
                </div>
            </div>
            <div class="row g-4">
            ...
            <div class="row g-4 mb-3">
                <div class="col-md-4">
                    ...
                    <input class="form-control" name="type_uz" id="type_uz" type="text" placeholder="..." aria-describedby="inputGroupPrepend2" required="" value="">
                </div>
                <div class="col-md-4">
                    <label class="form-label" for="type_ru">Тип Ru</label>
                    <input class="form-control" name="type_ru" id="type_ru" type="text" placeholder="..." aria-describedby="inputGroupPrepend2" required="" value="">
                </div>
                <div class="col-md-4">
                    <label class="form-label" for="type_en">Тип En</label>
                    <input class="form-control" name="type_en" id="type_en" type="text" placeholder="..." aria-describedby="inputGroupPrepend2" required="" value="">
                </div>
            </div>
