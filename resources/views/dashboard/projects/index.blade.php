                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{route('admin.projects.edit', $project->id)}}" method="GET" style="display: inline;">
                                ...
                                <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{$project->id}}" data-bs-original-title="" title=""><i data-feather="trash-2"></i></button>
                        </td>
